                    ...
                    <div class="content-sidebar">
                        ...
                        <div class="job-meta-card">
                            ...
                            <div class="share-section">
                                <p class="share-title">Compartir este trabajo</p>
                                <div class="share-buttons">
                                    <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php the_job_permalink(); ?>"
                                       target="_blank"
                                       class="share-btn"
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?php the_job_permalink(); ?>&text=<?php echo urlencode(get_the_title()); ?>"
                                       target="_blank"
                                       class="share-btn"
                                    ...
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_job_permalink(); ?>"
                                       target="_blank"
                                       class="share-btn"
